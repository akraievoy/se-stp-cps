...
class NumberBuilder {
    ...
    public MultiPowNumber valueOf(final long value) {
        int digitCount = 0;
        ...
        return withDigits(digits).build();
    }
}
...
public class MultiPowNumbers {
    ...
    public static void main(String[] args) {
        ...
        final MultiPowNumber a =
                new NumberBuilder()
                        .withPowers(new long[]{1, 10, 100, 1000})
                        .valueOf(123);
        ...
        System.out.println("var00: nothing to do here :)");
